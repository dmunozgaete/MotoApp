...
namespace API.Endpoints.Ambassadors.Services
{
    ...
    public class Unfollow : Gale.REST.Http.HttpUpdateActionResult<String>
    {
        ...
        public Unfollow(String user, String ambassador) : base(user, ambassador) { }
        ...
        {
            using (Gale.Db.DataService svc = new Gale.Db.DataService("[PA_MOT_ELM_SeguimientoEmbajador]"))
            {
