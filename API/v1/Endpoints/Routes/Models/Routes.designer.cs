...
namespace API.Endpoints.Routes.Models
{
	...
	public partial class NewRoute
	{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="RUTA_Sensacion", Storage="_sensation", DbType="Char(4)", CanBeNull=false)]
		public string sensation
		{
			get
			{
				return this._sensation;
			}
			set
			{
				if ((this._sensation != value))
				{
					this._sensation = value;
				}
			}
		}
