...
namespace API.Endpoints.Routes.Services
{
    ...
    public class Create : Gale.REST.Http.HttpCreateActionResult<Models.NewRoute>
    {
        ...
        public override System.Threading.Tasks.Task<System.Net.Http.HttpResponseMessage> ExecuteAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            Gale.Exception.RestException.Guard(() => Model.sensation == null, "EMPTY_SENSATION", API.Errors.ResourceManager);
            ...
            try
            {
                ...
                {
                    svc.Parameters.Add("ENTI_Token", _user);
                    svc.Parameters.Add("RUTA_Inicio", Model.start);
                    svc.Parameters.Add("RUTA_Fin", Model.end);
                    ...
                    svc.Parameters.Add("TISE_Identificador", Model.sensation);
                ...
                try
                {
                    Model.coordinates.ForEach((coordinate) =>
                    {
                        ...
                        using (Gale.Db.DataService coord = new Gale.Db.DataService("PA_MOT_INS_CoordenadaRuta"))
                        {
                            ...
                            coord.Parameters.Add("COOR_Fecha", coordinate.createdAt);
