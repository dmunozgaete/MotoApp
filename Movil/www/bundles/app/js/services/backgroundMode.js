...
angular.module('app.services')
    .provider('backgroundMode', function()
    {
        var $ref = this;
        ...
        var _enable = false;
        var _debug = false;
        var _notifyText = "BackgroundMode is running";
        ...
        this.$get = function($log)
        {
            if (_enable)
            {
                ...
                ionic.Platform.ready(function()
                {
                    ...
                    {
                        $log.error('BackgroundMode plugin is not installed');
                        return;
                    }

                    if (_debug)
                    {
                        $log.info("BackgroundMode: enable");
                    }
                    ...
                    cordova.plugins.backgroundMode.onactivate = function()
                    {
                        if (_debug)
                        {
                            $log.info("BackgroundMode: active");
                        }
                    };
